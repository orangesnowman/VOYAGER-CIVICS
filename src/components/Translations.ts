...
export const translations = {
  EN: {
    ...
    welcomeMsg: "Voyager USA is your passport to American English. An app designed for you to speak with confidence in real situations, with tools that clearly show your progress and areas to reinforce.",
  ...
  ES: {
    ...
    welcomeMsg: "Voyager USA es tu pasaporte al inglés americano. Una app pensada para que hables con confianza en situaciones reales, con herramientas que muestran claramente tus avances y tus áreas a reforzar.",
    endConversation: "FINALIZAR",
    reviewChat: "Califica tu Sesión con Voyager",
    submitReview: "Enviar Calificación",
